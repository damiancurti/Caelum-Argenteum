#!/usr/bin/env python3
"""Build the deterministic source-only Caelum Argenteum 4.32.0l patch."""
...
def load_audit(project: Path):
    audit_path = project / "tools/audit_4_32_0l.py"
    spec = importlib.util.spec_from_file_location("caelum_audit_4_32_0l", audit_path)
...
def main() -> None:
    ...
    audit_command = [
        sys.executable,
        str(project / "tools/audit_4_32_0l.py"),
