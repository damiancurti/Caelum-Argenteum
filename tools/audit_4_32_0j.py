#!/usr/bin/env python3
"""Deterministic focused audit for Caelum Argenteum 4.32.0j."""
...
PROJECT_FILES = {
    "APLICAR_4_32_0j.txt",
    "PRUEBAS_4_32_0j.txt",
    "docs/DOMINGO_FP_4_32_0j_ARTE.md",
    "docs/DOMINGO_FP_4_32_0j_SHA256.txt",
    "docs/FIRST_PERSON.md",
    "docs/IMPLEMENTATION_STATUS.md",
    "docs/ROADMAP.md",
    "tools/audit_4_32_0j.py",
    "tools/build_source_patch_4_32_0j.py",
    "tools/inject_png_grab_4_32_0j.mjs",
    "art_source/domingo_fp_4_32_0j/IMAGEGEN_PROMPTS.txt",
    *ART_SPECS,
}
FIXED_ZIP_TIME = (2026, 9, 6, 22, 0, 0)
...
def read_manifest(project: Path) -> dict[str, str]:
    path = project / "docs/DOMINGO_FP_4_32_0j_SHA256.txt"
    result: dict[str, str] = {}
...
def check_sources(project: Path, baseline_root: Path) -> None:
    ...
    required = (
        ...
        "invoker.CaelumSwordViewBlocking ? 160.0 : 288.0",
        "invoker.CaelumSwordViewBlocking ? 0.0 : 28.0",
    ...
    required_docs = {
        "docs/FIRST_PERSON.md": ("V4.32.0j", "X=82, Y=45", "X=288, Y=28", "43°"),
        "docs/IMPLEMENTATION_STATUS.md": ("4.32.0j", "exact horizontal mirror", "(288,28)"),
        "docs/ROADMAP.md": ("V4.32.0j", "V4.33", "marked blue zones"),
        "docs/DOMINGO_FP_4_32_0j_ARTE.md": (
            "precise-object-edit", "RHNDH0", "exact horizontal mirror"
        ),
        "APLICAR_4_32_0j.txt": ("NO contiene un PK3", "4.32.0f–4.32.0i"),
        "PRUEBAS_4_32_0j.txt": ("círculos azules", "mano de Block", "once puntos"),
        "art_source/domingo_fp_4_32_0j/IMAGEGEN_PROMPTS.txt": (
...
def main() -> None:
    ...
    print("Caelum Argenteum 4.32.0j audit: PASS")
    print(f"Runtime delta from 4.32.0f: {len(RUNTIME_FILES)} files")
    print("Idle: shield (105,0), left hand (82,45), right rig (288,28)")
    print("Held Block: accepted shield at (160,100); H/I hand layers mirrored")
    print("Sword angles unchanged: ~79-degree rest to ~104-degree impact")
