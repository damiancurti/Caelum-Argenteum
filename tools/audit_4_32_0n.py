#!/usr/bin/env python3
"""Deterministic focused audit for Caelum Argenteum 4.32.0n."""
...
PROJECT_FILES = {
    ...
    "docs/DOMINGO_FP_4_32_0n_SHA256.txt",
    "docs/FIRST_PERSON.md",
    "docs/IMPLEMENTATION_STATUS.md",
    "docs/ROADMAP.md",
    "tools/audit_4_32_0n.py",
    "tools/build_source_patch_4_32_0n.py",
    "tools/inject_png_grab_4_32_0n.mjs",
    "art_source/domingo_fp_4_32_0j/IMAGEGEN_PROMPTS.txt",
    "art_source/domingo_fp_4_32_0n/IMAGEGEN_PROMPTS.txt",
    *ART_SPECS,
}
FIXED_ZIP_TIME = (2026, 9, 7, 7, 30, 0)
...
def read_manifest(project: Path) -> dict[str, str]:
    path = project / "docs/DOMINGO_FP_4_32_0n_SHA256.txt"
    result: dict[str, str] = {}
...
def check_sources(project: Path, baseline_root: Path) -> None:
    ...
    pivot_points = (
        (0.325 * 480 - 160, 0.725 * 240 - 72),
        (0.55625 * 320 - 160 - 22, 0.83 * 200 - 32 - 32),
        (0.4875 * 320 - 160, 0.67 * 200 - 32),
    )
    require(
        all(abs(x + 4) < 1e-9 and abs(y - 102) < 1e-9
            for x, y in pivot_points),
        "layer pivots do not resolve to the common (-4,102) grip",
    )
    require(
    ...
    required_docs = {
        "docs/FIRST_PERSON.md": (
            "V4.32.0n", "X=82, Y=45", "X=282, Y=32", "X=260, Y=0",
            "443 píxeles", "(-22,-32)", "0→25°",
        ),
        "docs/IMPLEMENTATION_STATUS.md": (
            "4.32.0n", "443", "(-22,-32)", "same screen-space",
        ),
        "docs/ROADMAP.md": ("V4.32.0n", "V4.33", "common grip pivot"),
        "docs/DOMINGO_FP_4_32_0k_TRAYECTORIA.md": (
        ...
        "docs/DOMINGO_FP_4_32_0n_RIG.md": (
            "(-4,102)", "443", "(+1,+1)", "giro_mano",
        ),
        "APLICAR_4_32_0n.txt": (
            "NO contiene un PK3", "V4.32.0g–V4.32.0m", "17 archivos",
        ),
        "PRUEBAS_4_32_0n.txt": (
            "pulgar", "Giro sincronizado", "línea recta", "diez puntos",
        ),
        "art_source/domingo_fp_4_32_0j/IMAGEGEN_PROMPTS.txt": (
...
def main() -> None:
    ...
    print("Caelum Argenteum 4.32.0n audit: PASS")
    ...
    print("Grip: hand/fingers apply the blade delta around one common pivot")
