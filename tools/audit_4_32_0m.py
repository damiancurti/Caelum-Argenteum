#!/usr/bin/env python3
"""Deterministic focused audit for Caelum Argenteum 4.32.0m."""
...
PROJECT_FILES = {
    ...
    "docs/DOMINGO_FP_4_32_0m_SHA256.txt",
    "docs/FIRST_PERSON.md",
    "docs/IMPLEMENTATION_STATUS.md",
    "docs/ROADMAP.md",
    "tools/audit_4_32_0m.py",
    "tools/build_source_patch_4_32_0m.py",
    "tools/inject_png_grab_4_32_0m.mjs",
    "art_source/domingo_fp_4_32_0j/IMAGEGEN_PROMPTS.txt",
    *ART_SPECS,
}
FIXED_ZIP_TIME = (2026, 9, 7, 6, 0, 0)
...
def read_manifest(project: Path) -> dict[str, str]:
    path = project / "docs/DOMINGO_FP_4_32_0m_SHA256.txt"
    result: dict[str, str] = {}
...
def check_sources(project: Path, baseline_root: Path) -> None:
    ...
    required = (
        ...
        "invoker.CaelumSwordViewBlocking ? 0.0 : 4.0",
    ...
    # The accepted hand curve is frozen; only the blade moves four units left.
    hand_path = (
        (300, 15), (318, -4), (287, -1), (236, 11),
        (201, 21), (228, 25), (255, 28), (275, 31), (282, 32),
    )
    blade_path = (
        (278, -13), (296, -32), (265, -29), (214, -17),
        (179, -7), (206, -3), (233, 0), (253, 3), (260, 4),
    )
    for hand, blade in zip(hand_path, blade_path):
        require(
            blade == (hand[0] - 22, hand[1] - 28),
            "blade registration is not the constant (-22,-28)",
        )
        if hand != hand_path[-1]:
            require(
    ...
    required_docs = {
        "docs/FIRST_PERSON.md": ("V4.32.0m", "X=82, Y=45", "X=282, Y=32", "X=260, Y=4"),
        "docs/IMPLEMENTATION_STATUS.md": ("4.32.0m", "wrong Block hand", "(-22,-28)"),
        "docs/ROADMAP.md": ("V4.32.0m", "V4.33", "another 16"),
        "docs/DOMINGO_FP_4_32_0k_TRAYECTORIA.md": (
        ...
        "APLICAR_4_32_0m.txt": ("NO contiene un PK3", "4.32.0f–4.32.0l"),
        "PRUEBAS_4_32_0m.txt": ("borde inferior izquierdo", "línea recta", "diez puntos"),
        "art_source/domingo_fp_4_32_0j/IMAGEGEN_PROMPTS.txt": (
...
def main() -> None:
    ...
    print("Caelum Argenteum 4.32.0m audit: PASS")
    print(f"Runtime delta from 4.32.0f: {len(RUNTIME_FILES)} files")
    print("Idle: shield/left hand (82,45), right hand (282,32), sword (260,4)")
    print("Held Block: shield/LHND retained; redundant layers 25/30/40 cleared")
    print("Attack: accepted hand curve retained; blade registered at (-22,-28)")
