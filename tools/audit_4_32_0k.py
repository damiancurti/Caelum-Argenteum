#!/usr/bin/env python3
"""Deterministic focused audit for Caelum Argenteum 4.32.0k."""
...
PROJECT_FILES = {
    ...
    "docs/DOMINGO_FP_4_32_0k_SHA256.txt",
    "docs/FIRST_PERSON.md",
    "docs/IMPLEMENTATION_STATUS.md",
    "docs/ROADMAP.md",
    "tools/audit_4_32_0k.py",
    "tools/build_source_patch_4_32_0k.py",
    "tools/inject_png_grab_4_32_0k.mjs",
    "art_source/domingo_fp_4_32_0j/IMAGEGEN_PROMPTS.txt",
    *ART_SPECS,
}
FIXED_ZIP_TIME = (2026, 9, 7, 3, 30, 0)
...
def read_manifest(project: Path) -> dict[str, str]:
    path = project / "docs/DOMINGO_FP_4_32_0k_SHA256.txt"
    result: dict[str, str] = {}
...
def check_sources(project: Path, baseline_root: Path) -> None:
    ...
    required = (
        ...
        "invoker.CaelumSwordViewBlocking ? 160.0 : 280.0",
    ...
    require(
        ...
        "idle shield and left hand do not share X=82",
    )
    require(
        sword.count("invoker.CaelumSwordViewBlocking ? 100.0 : 45.0") == 2,
        "idle shield and left hand do not share Y=45",
    )
    ...
    required_docs = {
        "docs/FIRST_PERSON.md": ("V4.32.0k", "X=82, Y=45", "X=282, Y=32", "X=280, Y=4"),
        "docs/IMPLEMENTATION_STATUS.md": ("4.32.0k", "black reference path", "straight-line return"),
        "docs/ROADMAP.md": ("V4.32.0k", "V4.33", "black attack curve"),
        "docs/DOMINGO_FP_4_32_0k_TRAYECTORIA.md": (
            "(318,-4)", "(201,21)", "colineales"
        ),
        "APLICAR_4_32_0k.txt": ("NO contiene un PK3", "4.32.0f–4.32.0j"),
        "PRUEBAS_4_32_0k.txt": ("curva negra", "línea recta", "doce puntos"),
        "art_source/domingo_fp_4_32_0j/IMAGEGEN_PROMPTS.txt": (
...
def main() -> None:
    ...
    print("Caelum Argenteum 4.32.0k audit: PASS")
    print(f"Runtime delta from 4.32.0f: {len(RUNTIME_FILES)} files")
    print("Idle: shield/left hand (82,45), right hand (282,32), sword (280,4)")
    print("Held Block: accepted shield at (160,100); H/I hand layers mirrored")
    print("Attack: five-point black curve; three collinear return points")
