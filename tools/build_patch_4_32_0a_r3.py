#!/usr/bin/env python3
"""Construye y audita la revisión Caelum Argenteum 4.32.0a-r3."""
...
PROJECT_FILES = {
    ...
    "docs/ROADMAP.md",
    "tools/audit_4_32_0a_r3.py",
    "tools/build_patch_4_32_0a_r3.py",
}
...
def run_audit(
    ...
    audit = project / "tools/audit_4_32_0a_r3.py"
    require(audit.is_file(), "Falta tools/audit_4_32_0a_r3.py")
    subprocess.run(
        [
            sys.executable,
            str(audit),
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="caelum_4_32_0a_r3_") as temp_name:
        temp = Path(temp_name)
