#!/usr/bin/env python3
"""Build the deterministic source-only Caelum Argenteum 4.33.0b patch."""
...
def load_audit(project: Path):
    audit_path = project / "tools/audit_4_33_0b.py"
    spec = importlib.util.spec_from_file_location("caelum_audit_4_33_0b", audit_path)
...
def main() -> None:
    ...
    audit_command = [
        sys.executable,
        str(project / "tools/audit_4_33_0b.py"),
        "--project-root", str(project),
        "--baseline-0a", str(args.baseline_0a.resolve()),
