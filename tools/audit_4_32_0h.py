#!/usr/bin/env python3
"""Deterministic focused audit for Caelum Argenteum 4.32.0h."""
...
SPRITE_SPECS = {
    ...
    "src/sprites/DSHDI0.png": (360, 240, (160, 48), False),
    "src/sprites/LHNDI0.png": (360, 240, (160, 48), False),
}
ART_SPECS = {
    "art_source/domingo_fp_4_32_0h/RHNDA0_2x_960x480.png": (960, 480),
    "art_source/domingo_fp_4_32_0h/DSHDI0_2x_720x480.png": (720, 480),
    "art_source/domingo_fp_4_32_0h/LHNDI0_2x_720x480.png": (720, 480),
}
RUNTIME_FILES = {
    PLAYABLE_WEAPONS,
...
PROJECT_FILES = {
    "APLICAR_4_32_0h.txt",
    "PRUEBAS_4_32_0h.txt",
    "docs/DOMINGO_FP_4_32_0h_ARTE.md",
    "docs/DOMINGO_FP_4_32_0h_SHA256.txt",
    "docs/FIRST_PERSON.md",
    "docs/IMPLEMENTATION_STATUS.md",
    "docs/ROADMAP.md",
    "tools/audit_4_32_0h.py",
    "tools/build_source_patch_4_32_0h.py",
    "tools/inject_png_grab_4_32_0h.mjs",
    *ART_SPECS,
}
FIXED_ZIP_TIME = (2026, 9, 6, 23, 30, 0)
...
def read_manifest(project: Path) -> dict[str, str]:
    path = project / "docs/DOMINGO_FP_4_32_0h_SHA256.txt"
    result: dict[str, str] = {}
...
def check_sources(project: Path, baseline_root: Path) -> None:
    ...
    required = (
        ...
        "A_OverlayRotate(30, 30.0);",
        "A_OverlayOffset(25, 174.0, 8.0);",
        "A_OverlayOffset(25, 132.0, -18.0);",
        "A_OverlayOffset(25, 148.0, -7.0);",
    ...
    required_docs = {
        "docs/FIRST_PERSON.md": ("V4.32.0h", "X=105", "118 %", "avance–retroceso"),
        "docs/IMPLEMENTATION_STATUS.md": ("4.32.0h", "visual proposal rejected"),
        "docs/ROADMAP.md": ("V4.32.0h", "V4.33"),
        "docs/DOMINGO_FP_4_32_0h_ARTE.md": ("background-extraction", "960×480"),
        "APLICAR_4_32_0h.txt": ("NO contiene un PK3", "4.32.0f o 4.32.0g"),
        "PRUEBAS_4_32_0h.txt": ("casi vertical", "diecisiete puntos"),
    }
...
def main() -> None:
    ...
    print("Caelum Argenteum 4.32.0h audit: PASS")
    print(f"Runtime delta from 4.32.0f: {len(RUNTIME_FILES)} files")
    print("Idle shield: X=105; held Block: frontal I at X=160, 118%, no loop")
    print("Sword: fixed near-vertical angle; attack is translate-only")
