#!/usr/bin/env python3
"""Build the deterministic source-only Caelum Argenteum 4.33.0a patch."""
...
def load_audit(project: Path):
    audit_path = project / "tools/audit_4_33_0a.py"
    spec = importlib.util.spec_from_file_location("caelum_audit_4_33_0a", audit_path)
...
def main() -> None:
    ...
    audit_command = [
        sys.executable,
        str(project / "tools/audit_4_33_0a.py"),
        "--project-root", str(project),
        "--baseline-0o", str(args.baseline_0o.resolve()),
        "--baseline-0d", str(args.baseline_0d.resolve()),
