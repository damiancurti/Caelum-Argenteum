#!/usr/bin/env python3
"""Build and audit the distributable Caelum Argenteum 4.32.0c patch."""
...
PROJECT_FILES = {
    ...
    "docs/ROADMAP.md",
    "tools/audit_4_32_0c.py",
    "tools/build_patch_4_32_0c.py",
}
...
def run_audit(
    ...
    subprocess.run(
        [
            sys.executable,
            str(project / "tools/audit_4_32_0c.py"),
...
def main() -> None:
    args = parse_args()
    with tempfile.TemporaryDirectory(prefix="caelum_4_32_0c_build_") as temp:
        temp_root = Path(temp)
