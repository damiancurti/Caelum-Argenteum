...
class CaelumSewerMaze : Object play
{
    ...
    static void Report()
    {
        ...
        Console.Printf("[Caelum 4.36.15] Laberinto MAP02: cofres=%d objetos restantes=%d Mandingas vivos=%d ratas vivas=%d Zupay vivo=%d",chests,objects,mandingas,rats,BossAlive());
