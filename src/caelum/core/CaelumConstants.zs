...
class CaelumConstants : Object
{
    ...
    const CRAFTING_RECIPE_BOOK_VERSION = 1;

    const CRAFTING_RECIPE_KIND_PHYSICAL_WEAPON = 0;
    const CRAFTING_RECIPE_KIND_ARMOR = 1;
    const CRAFTING_RECIPE_KIND_ESSENCE_WEAPON = 2;
    const CRAFTING_RECIPE_KIND_AMULET = 3;
    const CRAFTING_RECIPE_KIND_SEAL = 4;
    ...
    const CRAFTING_RECIPE_FILTER_ESSENCE_WEAPON = 3;
    const CRAFTING_RECIPE_FILTER_AMULET = 4;
    const CRAFTING_RECIPE_FILTER_SEAL = 5;
    const CRAFTING_RECIPE_FILTER_COUNT = 6;
