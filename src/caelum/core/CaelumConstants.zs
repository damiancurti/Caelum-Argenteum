...
class CaelumConstants : Object
{
    ...
    const MAIN_M00_RESIDENT_RONNIE = 1;
    const MAIN_M00_RESIDENT_CAELLA = 2;
    const MAIN_M00_RESIDENT_COUNT = 3;
    const MAIN_M00_RESIDENT_ARGENTO = 3;
    const MAIN_M00_SOCIAL_UNTRIED = 0;
    const MAIN_M00_SOCIAL_SUCCESS = 1;
    const MAIN_M00_SOCIAL_FAILURE = 2;
    const MAIN_M00_RULO_EMOTION_DIFFICULTY = 120.0;
    const MAIN_M00_CAELLA_PERSUASION_DIFFICULTY = 120.0;
    const MAIN_M00_RONNIE_MINIMUM_LABIA = 1.0;
    const MAIN_M00_ARGENTO_CONVERSATION_ID = 43310;
    const MAIN_M00_RULO_CONVERSATION_ID = 43311;
    const MAIN_M00_RONNIE_CONVERSATION_ID = 43312;
    const MAIN_M00_CAELLA_CONVERSATION_ID = 43313;
    ...
    const PALOMO_MERCHANT_ACTION_PRICE_CHANGED = 10;
