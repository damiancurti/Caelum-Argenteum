...
None of the runtime defects below is labelled RESOLVED-VERIFIED; CA-KP-001 below is a resolved tooling contract, not a runtime defect. This register still records no new engine run.
